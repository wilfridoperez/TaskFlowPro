...
NEXTAUTH_URL=https://taskflowpro-e0bsbbdea4gdczha.canadaeast-01.azurewebsites.net
NODE_ENV=production
```

### Database Variables
```
DATABASE_URL=postgresql://xptxlmkire:Venezuela12!@taskflowpro-postgres.postgres.database.azure.com/postgres?sslmode=require
```
